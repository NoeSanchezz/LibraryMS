...
INSERT INTO PUBLISHER VALUES('publisher_name','phone','address');
...
CREATE TABLE LIBRARY_BRANCH(
    ...
    Branch_Address VARCHAR(50) NOT NULL, LateFee INT,
    PRIMARY KEY (Branch_Id)

);
INSERT INTO LIBRARY_BRANCH VALUES('branch_id','branch_name','branch_address',2);
INSERT INTO LIBRARY_BRANCH VALUES(1,'Main Branch','123 Main St, New York, NY 10003',3);
INSERT INTO LIBRARY_BRANCH VALUES(2,'West Branch','456 West St, Arizona, AR 70622',4);
INSERT INTO LIBRARY_BRANCH VALUES(3,'East Branch','789 East St, New Jersy, NY 32032',5);
INSERT INTO LIBRARY_BRANCH VALUES(4,'North Branch','456 NW, Irving, TX 76100 ',2);
INSERT INTO LIBRARY_BRANCH VALUES(5,'UTA Branch','123 Cooper St, Arlington, TX 76101 ',2);
CREATE TABLE BOOK
(
...
INSERT INTO BOOK VALUES('book_id','title','book_publisher');
...
(
    ...
    Date_out DATE,
    Due_date DATE,
    Returned_date DATE, Late INT DEFAULT 0,
    PRIMARY KEY (Book_id,Branch_id,Card_no),
    FOREIGN KEY (Book_id) REFERENCES BOOK(Book_id),
    FOREIGN KEY (Branch_id) REFERENCES LIBRARY_BRANCH(Branch_id),
    FOREIGN KEY (Card_no) REFERENCES BORROWER(Card_no)
);
INSERT INTO BOOK_LOANS VALUES('book_id','branch_id','card_no','date_out','due_date','Returned_date',0);
...
CREATE TABLE IF NOT EXISTS "LIBARARY_BRANCH"(
"branch_id" TEXT, "branch_name" TEXT, "branch_address" TEXT);
INSERT INTO LIBARARY_BRANCH VALUES('1','Main Branch','123 Main St, New York, NY 10003');
INSERT INTO LIBARARY_BRANCH VALUES('2','West Branch','456 West St, Arizona, AR 70622');
INSERT INTO LIBARARY_BRANCH VALUES('3','East Branch','789 East St, New Jersy, NY 32032');
...
INSERT INTO BORROWER VALUES('card_no','name','address','phone');
...
INSERT INTO BORROWER VALUES(NULL,'Abudlmizz Wahab','2223 South St, Universe, Un 70000','837-721-8965');
INSERT INTO BORROWER VALUES(NULL,'Noe Sanchez','2223 Abram St, Galaxy, GL n  70120','111-111-1111');
CREATE VIEW vBookLoanInfo AS
SELECT bl.Card_No,br.FName,bl.Date_Out,bl.Due_Date,bl.Returned_date,
(JULIANDAY(bl.Returned_date) - JULIANDAY(bl.Due_Date)) AS TotalDays,
...
CREATE TRIGGER update_copies_on_checkout
